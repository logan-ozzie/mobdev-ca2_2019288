...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["episode-details-episode-details-module"], {
  ...
  function srcAppPagesEpisodeDetailsEpisodeDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EpisodeDetailsPage = /*#__PURE__*/function () {
      ...
      _createClass(EpisodeDetailsPage, [{
        ...
        key: "favouriteFilm",
        value: function favouriteFilm() {
          var _this2 = this;

          this.favouriteService.favouriteFilm(this.episodeId).then(function () {
            _this2.isFavourite = true;
          });
        }
      }, {
        key: "unfavouriteFilm",
        value: function unfavouriteFilm() {
          var _this3 = this;

          this.favouriteService.unfavouriteFilm(this.episodeId).then(function () {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getDeath(id) {
          return this.http.get("http://www.breakingbadapi.com/api/deaths/".concat(id));
        }
      }]);
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY = 'favouriteFilms';
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        ...
        key: "favouriteFilm",
        value: function favouriteFilm(episodeId) {
          var _this4 = this;
        ...
        key: "unfavouriteFilm",
        value: function unfavouriteFilm(episodeId) {
          var _this5 = this;
